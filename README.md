...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `71.4µs` | `78.3µs` |
| [Day 2](./src/bin/02.rs) | `15.8ms` | `480.5ms` |
| [Day 3](./src/bin/03.rs) | `85.2µs` | `221.0µs` |
| [Day 4](./src/bin/04.rs) | `327.3µs` | `8.3ms` |
| [Day 5](./src/bin/05.rs) | `147.0µs` | `62.7µs` |
| [Day 6](./src/bin/06.rs) | `74.9µs` | `306.6µs` |
| [Day 7](./src/bin/07.rs) | `259.3µs` | `337.8µs` |
| [Day 8](./src/bin/08.rs) | `64.9ms` | `66.6ms` |
